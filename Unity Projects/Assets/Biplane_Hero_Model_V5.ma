...
//Name: Biplane_Hero_Model_V5.ma
//Last modified: Fri, Feb 21, 2014 12:17:58 PM
//Codeset: 1252
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -17.291367283583131 7.8068097249732258 12.865099481693971 ;
	setAttr ".r" -type "double3" -11.400000000000309 665.99999999998352 1.3527707053979385e-015 ;
	setAttr ".rpt" -type "double3" 4.111704684978128e-016 2.2350285760931883e-017 1.5402018347102294e-016 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999979;
	setAttr ".coi" 21.87785893447035;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 0.32587744739586683 4.5077580054251216 -1.3696912522967035 ;
	setAttr ".hc" -type "string" "viewSet -p %camera";
	setAttr ".dep" yes;
createNode transform -s -n "top";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.040486289349128152 16.776096476579394 3.7871511541683285 ;
...
createNode transform -s -n "front";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.096571017771309275 3.7145505388227953 100.10056772418621 ;
createNode camera -s -n "frontShape" -p "front";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 21.439974421718542;
...
createNode transform -s -n "side";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -15.585055398163401 3.7145505350537875 1.5405745062213523 ;
...
createNode transform -n "pasted__pCube10" -p "group";
	setAttr ".t" -type "double3" -12.722279487272189 2.4015722515688793 -1.1602815317493329 ;
...
createNode transform -n "pasted__pCube13" -p "group";
	setAttr ".t" -type "double3" -3.9700567618248286 2.4015722515688793 -1.1602815317493329 ;
	setAttr ".r" -type "double3" 5 0 0 ;
...
createNode transform -n "pasted__pCube14" -p "group";
	setAttr ".t" -type "double3" -12.722279487272189 5.3094450248853615 -1.1602815317493329 ;
	setAttr ".r" -type "double3" 5 0 0 ;
...
// End of Biplane_Hero_Model_V5.ma
