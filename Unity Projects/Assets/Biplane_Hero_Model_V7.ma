...
//Name: Biplane_Hero_Model_V7.ma
//Last modified: Fri, Feb 28, 2014 09:21:20 AM
//Codeset: 1252
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -7.193768967118257 2.3268471848712169 18.391789409714352 ;
	setAttr ".r" -type "double3" 6.6000000000051688 -20.799999999997294 2.1264356832584075e-016 ;
	setAttr ".rpt" -type "double3" 4.111704684978128e-016 2.2350285760931883e-017 1.5402018347102294e-016 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999979;
	setAttr ".coi" 19.919660073183994;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 0.11626798091323565 4.9621159015913978 -0.70527404388903081 ;
...
createNode transform -s -n "front";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.11626798091323565 5.2860350632781454 100.1128180137933 ;
createNode camera -s -n "frontShape" -p "front";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 42.552366483581856;
...
createNode mesh -n "pasted__pCubeShape11" -p "pasted__pCube11";
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 6 ".pt";
	setAttr ".pt[73]" -type "float3" -0.71662074 3.2782555e-007 0.18196329 ;
	setAttr ".pt[75]" -type "float3" -0.71662074 3.2782555e-007 0.18196329 ;
	setAttr ".pt[159]" -type "float3" -0.95330644 -0.051931057 0.99044758 ;
	setAttr ".pt[160]" -type "float3" -0.14836122 0 0 ;
	setAttr ".pt[161]" -type "float3" -1.1075178 -0.10283779 0.64749777 ;
	setAttr ".pt[163]" -type "float3" -1.1075178 0.0013411759 0.64749777 ;
	setAttr ".dr" 1;
...
createNode transform -n "directionalLight1";
	setAttr ".t" -type "double3" 10.145747116053066 12.219726550300384 1.4693513573131773 ;
	setAttr ".r" -type "double3" -83.137744347994072 -26.303617611435865 -40.610961386270191 ;
...
createNode transform -n "directionalLight2";
	setAttr ".t" -type "double3" -11.789798725862902 -7.3323996387056232 3.5489336322927434 ;
	setAttr ".r" -type "double3" -260.06987213616333 173.08906158120379 -34.500933723680248 ;
...
createNode hyperLayout -n "hyperLayout1";
	...
	setAttr ".hyp[17].x" 219.64285278320312;
	setAttr ".hyp[17].y" -43.452381134033203;
	setAttr ".hyp[17].nvs" 1920;
	setAttr ".hyp[18].x" 219.64285278320312;
	setAttr ".hyp[18].y" -43.452381134033203;
	setAttr ".hyp[18].nvs" 1920;
	setAttr ".hyp[19].x" 219.64285278320312;
	setAttr ".hyp[19].y" -43.452381134033203;
	setAttr ".hyp[19].nvs" 1920;
	setAttr ".hyp[20].x" 219.64285278320312;
	setAttr ".hyp[20].y" -43.452381134033203;
...
connectAttr "polySubdFace3.out" "pasted__pCubeShape11.i";
...
connectAttr "directionalLight2.msg" "hyperLayout1.hyp[19].dn";
connectAttr "directionalLightShape2.msg" "hyperLayout1.hyp[20].dn";
connectAttr "bump2d1.o" "Blue.n";
connectAttr "Blue.oc" "lambert4SG.ss";
connectAttr "pasted__pCubeShape11.iog" "lambert4SG.dsm" -na;
...
// End of Biplane_Hero_Model_V7.ma
