...
//Name: Biplane_Hero_Model_V3.ma
//Last modified: Fri, Jan 24, 2014 10:11:28 AM
//Codeset: 1252
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -45.342128689691158 13.931339204295895 22.535857588978239 ;
	setAttr ".r" -type "double3" -7.1999999999998527 -65.199999999998056 -1.8956603236505584e-015 ;
	setAttr ".rpt" -type "double3" 4.111704684978128e-016 2.2350285760931883e-017 1.5402018347102294e-016 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999979;
	setAttr ".coi" 48.524787446887103;
...
createNode transform -n "pPlane1";
	setAttr ".t" -type "double3" -10.646835316852663 0 -11.261798242787551 ;
createNode mesh -n "Biplane_Reference" -p "pPlane1";
	setAttr -k off ".v";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 4 ".pt[0:3]" -type "float3"  30.141489 2.380209 2.2627115 
		15.280515 2.380209 21.103241 30.236145 20.228962 15.775459 15.375139 20.228962 34.616043;
...
createNode polyPlane -n "polyPlane1";
	setAttr ".w" 14.267328359114462;
	setAttr ".h" 13.509782205888019;
	setAttr ".sw" 1;
	setAttr ".sh" 1;
	setAttr ".cuv" 2;
...
connectAttr "groupId1.id" "Biplane_Reference.iog.og[0].gid";
connectAttr "lambert2SG.mwc" "Biplane_Reference.iog.og[0].gco";
connectAttr "groupParts1.og" "Biplane_Reference.i";
connectAttr "groupId2.id" "Biplane_Reference.ciog.cog[0].cgid";
...
connectAttr "Biplane_Reference.iog.og[0]" "lambert2SG.dsm" -na;
...
connectAttr "Biplane_Reference.ciog.cog[0]" ":initialShadingGroup.dsm" -na;
...
// End of Biplane_Hero_Model_V3.ma
