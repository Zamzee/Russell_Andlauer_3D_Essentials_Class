...
//Name: ATC_Tower_Placeholder_1_V1.ma
//Last modified: Mon, Feb 03, 2014 09:33:09 PM
//Codeset: 1252
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -13.265335025203374 15.378279830239135 -44.951134482905275 ;
	setAttr ".r" -type "double3" 345.26164726985775 1277.3999999999651 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 40.109645504737735;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 0.096884620498183693 1.6119637421123254 3.0759402283781303 ;
...
createNode transform -s -n "front";
	...
	setAttr ".r" -type "double3" -1.139565987452016e-014 -0.001256190911788896 -0.0012561914920583945 ;
...
createNode mesh -n "pCubeShape27" -p "pCube27";
	...
	setAttr -s 44 ".pt";
	setAttr ".pt[16]" -type "float3" 0.52207553 -1.4901161e-008 -1.1799512 ;
	setAttr ".pt[17]" -type "float3" 1.0441504 -1.4901161e-008 -0.59618181 ;
	setAttr ".pt[18]" -type "float3" -0.52207649 -1.4901161e-008 -1.1799512 ;
	setAttr ".pt[19]" -type "float3" -1.0441504 -1.4901161e-008 -0.59618181 ;
	setAttr ".pt[20]" -type "float3" -1.0441504 -1.4901161e-008 0.57136136 ;
	setAttr ".pt[21]" -type "float3" -0.52207649 -1.4901161e-008 1.1551317 ;
	setAttr ".pt[22]" -type "float3" 0.52207553 -1.4901161e-008 1.1551317 ;
	setAttr ".pt[23]" -type "float3" 1.0441504 -1.4901161e-008 0.57136136 ;
	setAttr ".pt[32]" -type "float3" -0.60797393 -1.4901161e-008 -1.1417501 ;
	setAttr ".pt[35]" -type "float3" 0.4721145 -1.4901161e-008 1.1799512 ;
	setAttr ".pt[40]" -type "float3" 0 0.32770133 0 ;
	setAttr ".pt[41]" -type "float3" 0 0.32770133 0 ;
	setAttr ".pt[43]" -type "float3" 0 0.32770133 0 ;
	setAttr ".pt[45]" -type "float3" 0 0.32770133 0 ;
	setAttr ".pt[48]" -type "float3" 0 0.32770133 0 ;
	setAttr ".pt[49]" -type "float3" 0 0.32770133 0 ;
	setAttr ".pt[51]" -type "float3" 0 0.32770133 0 ;
	setAttr ".pt[53]" -type "float3" 0 0.32770133 0 ;
	setAttr ".pt[55]" -type "float3" 0 0.32770133 0 ;
	setAttr ".pt[57]" -type "float3" 0 0.32770133 0 ;
	setAttr ".pt[58]" -type "float3" -0.4148888 -7.4505806e-009 0.91797125 ;
	setAttr ".pt[59]" -type "float3" -0.82977647 -7.4505806e-009 0.45405525 ;
	setAttr ".pt[60]" -type "float3" 0 -0.32770133 0 ;
	setAttr ".pt[61]" -type "float3" 0 -0.32770133 0 ;
	setAttr ".pt[62]" -type "float3" -0.82977647 -7.4505806e-009 -0.47377944 ;
	setAttr ".pt[63]" -type "float3" 0 -0.32770133 0 ;
	setAttr ".pt[64]" -type "float3" -0.48315114 -7.4505806e-009 -0.90733862 ;
	setAttr ".pt[65]" -type "float3" 0 -0.32770133 0 ;
	setAttr ".pt[66]" -type "float3" 0.41488859 -7.4505806e-009 -0.93769574 ;
	setAttr ".pt[67]" -type "float3" -0.4148888 -7.4505806e-009 -0.93769574 ;
	setAttr ".pt[68]" -type "float3" 0 -0.32770133 0 ;
	setAttr ".pt[69]" -type "float3" 0 -0.32770133 0 ;
	setAttr ".pt[70]" -type "float3" 0.82977647 -7.4505806e-009 -0.47377944 ;
	setAttr ".pt[71]" -type "float3" 0 -0.32770133 0 ;
	setAttr ".pt[72]" -type "float3" 0.82977647 -7.4505806e-009 0.45405525 ;
	setAttr ".pt[73]" -type "float3" 0 -0.32770133 0 ;
	setAttr ".pt[74]" -type "float3" 0.41488859 -7.4505806e-009 0.91797125 ;
	setAttr ".pt[75]" -type "float3" 0 -0.32770133 0 ;
	setAttr ".pt[76]" -type "float3" 0.3751848 -7.4505806e-009 0.93769574 ;
	setAttr ".pt[77]" -type "float3" 0 -0.32770133 0 ;
	setAttr ".pt[78]" -type "float3" 0 -2.6302803 0 ;
	setAttr ".pt[79]" -type "float3" 0 -2.6302803 0 ;
	setAttr ".pt[80]" -type "float3" 0 -2.6302803 0 ;
	setAttr ".pt[81]" -type "float3" 0 -2.6302803 0 ;
...
connectAttr "polyExtrudeFace17.out" "pCubeShape27.i";
...
// End of ATC_Tower_Placeholder_1_V1.ma
